      ...
      try {
        ...
        const params = {
          ...
          FIELDS: {
            ...
            PROPERTY_1487: data.senderContactName, // контактное лицо отправителя
            PROPERTY_1315: data.senderPhoneNumber, // телефон отправителя
            PROPERTY_1485: data.recipientCompany, // компания получатель
            PROPERTY_1209: data.recipientAddress, // адрес получателя
            PROPERTY_1207: data.recipientContactName, // контактное лицо получателя
            PROPERTY_1317: data.recipientPhoneNumber, // телефон получателя
            ...
            PROPERTY_1689: data.costOfCargo,
