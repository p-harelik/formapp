<template>
  <div>
    ...
    <div class="wrapper-form">
      <form @submit.prevent>
        <p class="subtitle-1 font-weight-medium black--text mt-4 mb-4">Информация по закупке</p>
        <v-text-field
  ...
  export default {
    ...
    data: () => ({
      ...
      urgencyOfPurchaseItems: [
        {
          value: 201,
          label: 'Срочно (1-3 дня)'
        },
        {
          value: 203,
          label: 'Средней срочности (3-7 дней)'
        },
        {
          value: 205,
          label: 'Не срочно (от 7 дней)'
        }
      ],
      deal: null,
      project: null,
